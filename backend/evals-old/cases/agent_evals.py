"""Existing agent evaluation test cases (output quality + trajectory).

These cases are used by the braintrust eval runners for output quality
and trajectory evaluations. Migrated from evals/cases.py.
"""
...
__all__ = ["OUTPUT_QUALITY_CASES", "TRAJECTORY_CASES"]
